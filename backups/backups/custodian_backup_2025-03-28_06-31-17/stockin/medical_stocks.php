...
function stockIn($conn, $item_id, $quantity) {
    ...
    $sql = "UPDATE medical_item SET item_qty = item_qty + ? WHERE item_id = ?";
...
// Fetch all medical items for the dropdown
$sql = "SELECT item_id, item_name FROM medical_item ORDER BY item_name";
...
<head>
    ...
    <title>Stock In - Medical Supplies</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-100 p-6">
    <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl p-6">
        <h2 class="text-2xl font-bold mb-4">Stock In - Medical Supplies</h2>
        <?php
        if ($message) {
        ...
        <form action="" method="post">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="../stocks/medical.php" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Back
                </a>
            </div>
        </form>
