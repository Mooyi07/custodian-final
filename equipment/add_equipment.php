...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO `item_equipment`(`item_name`, `item_code`, `item_qty`, `item_unit`, `item_brand`, `date_purchase`, `item_location`, `item_life`, `item_remarks`, `equipment_type`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssiissssss", $item_name, $item_code, $item_qty, $item_unit, $item_brand, $date_purchase, $item_location, $item_life, $item_remarks, $equipment_type);
    ...
    <div class="d-flex h-100">
        ...
        <div class="flex-grow-1">
            <div class="container form-container">
                <h1 class="text-3xl fw-bold mb-3 text-center">Add New Equipment</h1>
                ...
                <div class="bg-white shadow rounded px-4 pt-4 pb-4 mb-3">
                    <form action="" method="POST">
                        <div class="row g-2">
                            <div class="col-md-6">
                                <label for="item_name" class="form-label fw-bold">Equipment Item</label>
                                <input type="text" class="form-control" id="item_name" name="item_name" placeholder="Enter Equipment Item" required>
                            </div>
                            <div class="col-md-6">
