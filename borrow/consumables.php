...
// Fetch all available supply items from the specified tables
$items_sql = "
    ...
    FROM academic_item WHERE item_qty > 0 AND equipment_type = 'Supply'
    UNION ALL
    ...
    FROM cleaning_item WHERE item_qty > 0 AND equipment_type = 'Supply'
    UNION ALL
    ...
    FROM item_equipment WHERE item_qty > 0 AND equipment_type = 'Supply'
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="main-content p-4">
                    <h1 class="text-3xl font-semibold mb-6">Get Supply Items</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-header bg-primary text-white">
                            Get Supply Item (Non-Returnable)
                        </div>
                        <div class="card-body">
                            <form action="handle_borrow.php" method="POST">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary me-2">
                                        <i class="fas fa-plus me-2"></i>Get Supply
                                    </button>
